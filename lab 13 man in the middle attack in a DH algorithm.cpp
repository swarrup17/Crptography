...
int main() {
   ...
   int p, g;
    ...
    // Alice and Bob exchange their public keys (but Eve intercepts and replaces them)
    ...
    int eve_shared_secret_with_alice = modExp(alice_public_key, eve_private_key, p);
    int eve_shared_secret_with_bob = modExp(bob_public_key, eve_private_key, p);
    cout << "Eve's Shared Secret with Alice: " << eve_shared_secret_with_alice << endl;
    cout << "Eve's Shared Secret with Bob: " << eve_shared_secret_with_bob << endl;
